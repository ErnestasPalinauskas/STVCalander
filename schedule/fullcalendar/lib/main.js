...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    var RAW_LT_LOCALE = __assign(__assign({}, MINIMAL_RAW_LT_LOCALE), {
    ...
    function queryLocale(codeArg, available) {
        ...
        var raw = queryRawLocale(codes, available) || RAW_LT_LOCALE;
    ...
    function parseLocale(codeArg, codes, raw) {
        var merged = mergeProps([MINIMAL_RAW_LT_LOCALE, raw], ['buttonText']);
    ...
    function buildDateEnv$1(settings) {
        var locale = buildLocale(settings.locale || 'lt', organizeRawLocales([]).map); // TODO: don't hardcode 'en' everywhere
